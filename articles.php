<h1 class="profile-header">Artykuły</h1>
...
<div class="articles-container">
    <?php
    include("connect.php");
    $query = "SELECT article_id,username,articles.user_id,add_date,title,description,image FROM articles INNER JOIN users ON articles.user_id=users.user_id";
    ...
    if ($result) {
        if (mysqli_num_rows($result) == 0) echo "<div class='text-center'>Nie znaleziona żadnych artykułów</div>";
